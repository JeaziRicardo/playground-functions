# :ferris_wheel: PROJECT PLAYGROUND FUNCTIONS

## :scroll: Sobre

<details>

O projeto **Playground Functions** foi executado como requisito obrigatório do curso de Desenvolvimento Web da [Trybe](https://www.betrybe.com/). Foi apenas o segundo projeto realizado do módulo de fundamentos, que abordou introdução ao JavaScript e lógica de programação.

> :eyes: Observação: nesse momento do curso ainda não era cobrado o uso do `ESLint`, por esse motivo existem erros de estrutura no código. Eu optei por deixar assim para verificar minha evolução quando comparado com outros projetos.
...
|![Imagem do progresso do projeto](/img/approved-project-pg-functions.png)|
|:--:|
